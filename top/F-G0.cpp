...
const arr_t<4> g_BCD{ 0.0, 1.0, 1.0, 1.0 };
        ...
        switch (_state) {
            ...
            case S_NORMAL:
                ...
                if (td >= 3.0 && td < 9.0) {
                    ...
                    r[3] = 0.0, r[4] = 1.0; // f012b[lu]
                    r[5] = 0.0, r[6] = 1.0; // curb[lu]
                    r[8] = 0.05 * (td - 20.0) / (23.5 - 20.0); // w1
                } else {
                    r[3] = 0.0, r[4] = 0.2; // f012b[lu]
                    r[5] = 0.0, r[6] = 0.0; // curb[lu]
                    r[8] = 0.05; // w1
                }
                r[7] = 1.0, r[9] = 3.0; // w[02]
                break;
            case S_SNAP:
                r[1] = 26.0, r[2] = _normal_tp2[td]; // tp[12]
                r[3] = 0.0, r[4] = 0.0; // f012b[lu]
                r[5] = 0.5, r[6] = 0.5; // curb[lu]
                r[7] = 1.0, r[8] = 0.8, r[9] = 2.2; // w[012]
                break;
            case S_SLEEP:
            case S_RSNAP:
...
private:
    ...
    bool _forced_f012{ false }, _disabled_f012{ false };
